...
namespace BigShop___.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult DeleteConfirmed(string id)
        {
            ...
            WishList deletewish = db.WishLists.FirstOrDefault(a => a.User.Id == id);
            Cart deletecart = db.Carts.FirstOrDefault(a => a.User.Id == id);
            Order deleteorder = db.Orders.FirstOrDefault(a => a.User.Id == id);
            if (deletewish!=null)
            {
